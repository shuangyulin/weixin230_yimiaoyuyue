 ...
 */
@TableName("yimiao_collection")
public class YimiaoCollectionView extends YimiaoCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String yimiaoCollectionValue;
	...
	public YimiaoCollectionView() {

	}

	public YimiaoCollectionView(YimiaoCollectionEntity yimiaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yimiaoCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getYimiaoCollectionValue() {
				return yimiaoCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setYimiaoCollectionValue(String yimiaoCollectionValue) {
				this.yimiaoCollectionValue = yimiaoCollectionValue;
			}
